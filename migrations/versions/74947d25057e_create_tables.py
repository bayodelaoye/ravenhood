...
Revision ID: 74947d25057e
Revises: 
Create Date: 2024-08-10 21:03:36.035370
...
def upgrade():
    ...
    sa.Column('price_earnings_ratio', sa.Numeric(precision=7, scale=2), nullable=True),
    ...
    sa.Column('fifty_two_week_high', sa.Numeric(precision=7, scale=2), nullable=True),
    sa.Column('fifty_two_week_low', sa.Numeric(precision=7, scale=2), nullable=True),
