...
Revision ID: 02f40828b003
Revises: 
Create Date: 2024-08-10 20:17:51.828466
...
def upgrade():
    ...
    sa.Column('price_earnings_ratio', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('dividend_yield', sa.Numeric(precision=4, scale=2), nullable=True),
    sa.Column('average_volume', sa.Integer(), nullable=True),
    sa.Column('high_today', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('low_today', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('open_price', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('volume', sa.Integer(), nullable=True),
    sa.Column('fifty_two_week_high', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('fifty_two_week_low', sa.Numeric(precision=5, scale=2), nullable=True),
